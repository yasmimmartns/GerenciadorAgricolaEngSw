                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                              ...
                              <ul class="dropdown-menu">
                                <li><a href="aaltAgricultor.jsp">Alterar dados</a></li>
                                <li><a href="#">Sair</a></li>
                              </ul>
                        </li>   
                    </ul>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="content">
                                <form role="form" action="EditaRegiao" method="POST">
                                    <div class="row">
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <label>ID</label>
                                                <input type="text" id="idRegiao" name="idRegiao" class="form-control" value="${idRegiao}"/>
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            <div class="form-group">
                                                <label>Endereço</label>
                                                <input type="text" id="endereco" name="endereco" class="form-control" value="${enderecoRegiao}"/>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Área (m²)</label>
                                                <input type="text" id="area" name="area" class="form-control" value="${areaRegiao}"/>
                                            </div>
                                        </div>
                                    </div>
