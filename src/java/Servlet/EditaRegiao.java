...
public class EditaRegiao extends HttpServlet {
    ...
    throws ServletException, IOException, Exception {
      try {
        ...
        regiao.setEndereco(endereco);
        regiao.setArea(area);
        regiao.setIdRegiao(idRegiao);
        
        RegiaoDAO pdao = new RegiaoDAO();
        pdao.altera(regiao);
        ...
        Logger.getLogger(EditaRegiao.class.getName()).log(Level.SEVERE, null, ex);
      }
