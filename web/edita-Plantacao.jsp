...
<%@page import="Classes.Plantacao"%>
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<jsp:useBean id="dao" class="DAOclasses.RegiaoDAO"/>
<jsp:useBean id="daop" class="DAOclasses.PlantacaoDAO"/>
<%@ page import= "DAOclasses.PlantacaoDAO" %>

<%
String id = request.getParameter("idp");
request.setAttribute("idPlantacao", id);
Plantacao p = daop.getPlantacao(id);
int idRegiao = p.getIdRegiao();
request.setAttribute("idRegiao", idRegiao);
String tipoPlantacao = p.getTipo();
request.setAttribute("tipoPlantacao", tipoPlantacao);
int quantidadePlantacao = p.getQuantidade();
request.setAttribute("quantidadePlantacao", quantidadePlantacao);

Regiao r = dao.getRegiao("9");
...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <form role="form" action="EditaPlantacao" method="POST" style="margin-top: 40px;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <label>ID</label>
                                                <input type="text" id="idPlantacao" name="idPlantacao" class="form-control" value="${idPlantacao}"/>
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>Tipo da Plantação</label>
                                                <input type="text" id="tipo" name="tipo" class="form-control" value="${tipoPlantacao}"/>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Quantidade</label>
                                                <input type="number" id="quantidade" name="quantidade" class="form-control" value="${quantidadePlantacao}"/>
                                            </div>
                                        </div>
                                         <div class="col-md-3">
                                            <div class="form-group">
